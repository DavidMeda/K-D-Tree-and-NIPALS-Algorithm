...
void pca(params *input)
{
    ...
    for (i = 0; i < input->h; i++)
    {
        ...
        do
        {
            ...
            prodMatriceTrasAss(input->ds, v, u, input->n, input->k);
            ...
            prodMatriceAss(input->ds, v, u, input->n, input->k);
        ...
        aggiornaDatasetAss(input->ds, u, v, input->n, input->k);
